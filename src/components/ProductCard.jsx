...
export default function ProductCard({ p }) {
  ...
  const img = imgs[idx] || "https://via.placeholder.com/600x400?text=Product";
  ...
  return (
    <div className="pCard">
      <div className="pImgWrap">
        ...
        <button className="pFav" type="button" onClick={onFav} title="Favorite">
          <span style={{ fontSize: 18 }}>{isFav(p._id) ? "❤️" : "🤍"}</span>
        </button>
